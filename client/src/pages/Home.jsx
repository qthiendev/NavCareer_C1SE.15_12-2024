...
import './Home.css';
import Feedback from './utilities/feedback/feedback.jsx';
...
const navigate = useNavigate();
  ...
  return (
    <div className="home-container">
      ...
      <div style={{ marginTop: '1%' }} className="intro-container">
        <div className="intro-left">
          <img src="./img/main_content/icon_intro1.svg" alt="Intro Image 1" />
        </div>
        <div className="intro-right intro_content">
          <h1 style={{ color: '#043873' }}>Bạn gặp khó khăn</h1>
          <h1 style={{ color: '#4F76F6' }}>trong việc chọn nghề?</h1>
      ...
      <div style={{ marginTop: '1%', backgroundColor: '#F8F9FA' }} className="intro-container">
        <div className="intro-left intro_content">
          <h1 style={{ color: '#043873' }}>Không biết điểm mạnh là gì?</h1>
          <h1 style={{ color: '#4F76F6' }}>Mơ hồ về tương lai?</h1>
          <p className="description_intro">
        ...
        <div className="intro-right">
          <img src="./img/main_content/icon_intro2.svg" alt="Intro Image 2" />
        </div>
      </div>

      <div style={{ margin: '1% 1%' }} className="intro-container">
        <div className="intro-left">
          <img src="./img/main_content/icon_intro3.svg" alt="Intro Image 3" />
        </div>
        <div className="intro-right intro_content">
          <h1 style={{ color: '#043873' }}>Đã có tư vấn nghề nghiệp</h1>
          <h1 style={{ color: '#4F76F6' }}>cá nhân hóa từ NavCareer</h1>
          <p className="description_intro">
